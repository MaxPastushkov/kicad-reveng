...
public:
    ...
    /**
     * Create and append an auto-generated net with a unique name.
     *
     * Creates a new net with an automatically assigned net code and a name in the format
     * "Net-(PCB-N)" where N is the net code. This is used for PCB-only workflows where
     * nets are created directly in the PCB editor without a schematic.
     *
     * @return Pointer to the newly created NETINFO_ITEM
     */
    NETINFO_ITEM* CreateAutoGeneratedNet();
